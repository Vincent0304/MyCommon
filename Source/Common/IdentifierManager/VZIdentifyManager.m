...
NSString * const kVZIdentifyChartboostAppID = @"kVZIdentifyChartboostAppID";
NSString * const kVZIdentifyChartboostAppSignature = @"kVZIdentifyChartboostAppSignature";
